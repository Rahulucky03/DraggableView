 ...
 */
package rahul.lucky.draggable.view;
...
import rahul.lucky.draggable.R;
import rahul.lucky.draggable.view.transformer.Transformer;
import rahul.lucky.draggable.view.transformer.TransformerFactory;
...
public class DraggableView extends RelativeLayout {
  ...
  public boolean onTouchEvent(MotionEvent ev) {
    ...
    if (isMaximized()) {
      ...
      dragView.dispatchTouchEvent(cloneMotionEventWithAction(ev));
    }
   ...
   */
  private MotionEvent cloneMotionEventWithAction(MotionEvent event) {
    return MotionEvent.obtain(event.getDownTime(), event.getEventTime(), MotionEvent.ACTION_CANCEL, event.getX(),
